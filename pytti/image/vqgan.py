...
path = '/home/daniel/Developer/workspace/creative-tools/sandbox/taming-transformers-master'
...
class VQGANImage(EMAImage):
  ...
  def rand_latent(self, device='cuda', vqgan_quantize_embedding=None):
...
'''
  @staticmethod
  def init_vqgan(model_name, device = 'cuda'):
